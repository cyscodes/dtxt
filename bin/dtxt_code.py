...
class Generator:
    """
    Code generator based on proto file.
    """
    ...
    def to_python_file(cls, proto_path, code_path):
        ...
        # Note: Python module filename generated by protoc will be set to "{proto_filename}_pb2"
